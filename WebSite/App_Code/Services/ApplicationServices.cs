...
namespace VSM.Services
{
    ...
    public class ApplicationServicesBase
    {
        ...
        public virtual JObject DefaultSettings
        {
            get
            {
                if (_defaultSettings == null)
                {
                    ...
                    EnsureJsonProperty(_defaultSettings, "appName", "<span ></span>");
                    ...
                    EnsureJsonProperty(ui, "theme.accent", "Modern");
        ...
        {
            VSM.Services.ApplicationServices.Initialize();
        }
        ...
        public static void RegisterStandardMembershipAccounts()
        {
            ...
            if (Membership.GetUser("admin") == null)
            {
                ...
                admin = Membership.CreateUser("admin", "admin123%", "admin@VSM.com", "ASP.NET", "Code OnTime", true, out status);
                user = Membership.CreateUser("user", "user123%", "user@VSM.com", "ASP.NET", "Code OnTime", true, out status);
