...
namespace VSM.Data
{
    ...
    public partial class DataControllerBase : IDataController, IAutoCompleteManager, IDataEngine, IBusinessObject
    {
        ...
        ViewPage IDataController.GetPage(string controller, string view, PageRequest request)
        {
            ...
            VSM.Security.EventTracker.Process(page, request);
            if (rules != null)
        ...
        ActionResult IDataController.Execute(string controller, string view, ActionArgs args)
        {
            ...
            try
            {
                ...
                if (args.SqlCommandType != CommandConfigurationType.None)
                	using (DbConnection connection = CreateConnection())
                    {
                        VSM.Security.EventTracker.Process(args, _config);
        ...
        public virtual string GetSurvey(string surveyName)
        {
            ...
            if (String.IsNullOrEmpty(survey))
            	survey = ControllerConfigurationUtility.GetResourceText(String.Format("VSM.Surveys.{0}.min.js", surveyName), String.Format("VSM.{0}.min.js", surveyName), String.Format("VSM.Surveys.{0}.js", surveyName), String.Format("VSM.{0}.js", surveyName));
            if (String.IsNullOrEmpty(survey))
            	throw new HttpException(404, "Not found.");
            if (String.IsNullOrEmpty(layout))
            	layout = ControllerConfigurationUtility.GetResourceText(String.Format("VSM.Surveys.{0}.html", surveyName), String.Format("VSM.Surveys.{0}.htm", surveyName), String.Format("VSM.{0}.html", surveyName), String.Format("VSM.{0}.htm", surveyName));
            if (String.IsNullOrEmpty(rules))
            	rules = ControllerConfigurationUtility.GetResourceText(String.Format("VSM.Surveys.{0}.rules.min.js", surveyName), String.Format("VSM.{0}.rules.min.js", surveyName), String.Format("VSM.Surveys.{0}.rules.js", surveyName), String.Format("VSM.{0}.rules.js", surveyName));
