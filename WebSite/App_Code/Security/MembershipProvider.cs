...
namespace VSM.Security
{
    ...
    public class ApplicationMembershipProviderBase : MembershipProvider
    {
        ...
        {
            Statements[MembershipProviderSqlStatement.ChangePassword] = "update Employee set password = @Password where emp_code = @UserName";
            Statements[MembershipProviderSqlStatement.ChangePasswordQuestionAndAnswer] = "update Employee set Column_users_passwordquestion_IsNotMapped = @PasswordQuestion" +
                ", Column_users_passwordanswer_IsNotMapped = @PasswordAnswer where emp_code = @Us" +
                "erName";
            Statements[MembershipProviderSqlStatement.CreateUser] = "\r\ninsert into Employee\r\n(\r\n   emp_code\r\n  ,password\r\n  ,emp_email\r\n)\r\nvalues(\r\n  " +
                " @UserName\r\n  ,@Password\r\n  ,@Email\r\n)";
            Statements[MembershipProviderSqlStatement.DeleteUser] = "delete from Employee where emp_code = @UserName";
            Statements[MembershipProviderSqlStatement.CountAllUsers] = "select count(*) from Employee";
            Statements[MembershipProviderSqlStatement.GetAllUsers] = "\r\nselect \r\n   emp_id UserID\r\n  ,emp_code UserName\r\n  ,emp_email Email\r\nfrom Emplo" +
                "yee \r\norder by emp_code asc";
            Statements[MembershipProviderSqlStatement.GetNumberOfUsersOnline] = "select count(*) from Employee where Column_users_lastactivitydate_IsNotMapped >= " +
                "@CompareDate";
            Statements[MembershipProviderSqlStatement.GetPassword] = "select password Password from Employee where emp_code = @UserName";
            Statements[MembershipProviderSqlStatement.GetUser] = "\r\nselect \r\n   emp_id UserID\r\n  ,emp_code UserName\r\n  ,emp_email Email\r\nfrom Emplo" +
                "yee \r\nwhere emp_code = @UserName";
            Statements[MembershipProviderSqlStatement.UpdateLastUserActivity] = "update Employee set Column_users_lastactivitydate_IsNotMapped = @LastActivityDate" +
                " where emp_code = @UserName";
            Statements[MembershipProviderSqlStatement.GetUserByProviderKey] = "\r\nselect \r\n   emp_id UserID\r\n  ,emp_code Username\r\n  ,emp_email Email\r\nfrom Emplo" +
                "yee \r\nwhere emp_id = @UserID";
            Statements[MembershipProviderSqlStatement.UpdateUserLockStatus] = "update Employee set Column_users_islockedout_IsNotMapped = @IsLockedOut where emp" +
                "_code = @UserName";
            Statements[MembershipProviderSqlStatement.GetUserNameByEmail] = "select emp_code Username from Employee where emp_email = @Email";
            Statements[MembershipProviderSqlStatement.ResetPassword] = "update Employee set password = @Password where emp_code = @UserName";
            Statements[MembershipProviderSqlStatement.UpdateUser] = "update Employee set emp_email = @Email where emp_code = @UserName";
            Statements[MembershipProviderSqlStatement.UpdateLastLoginDate] = "update Employee set Column_users_lastlogindate_IsNotMapped = @LastLoginDate where" +
                " emp_code = @UserName";
            Statements[MembershipProviderSqlStatement.UpdateFailedPasswordAttempt] = "update Employee set  where emp_code = @UserName";
            Statements[MembershipProviderSqlStatement.UpdateFailedPasswordAnswerAttempt] = "update Employee set  where emp_code = @UserName";
            Statements[MembershipProviderSqlStatement.CountUsersByName] = "select count(*) from Employee where emp_code like @UserName";
            Statements[MembershipProviderSqlStatement.FindUsersByName] = "\r\nselect \r\n   emp_id UserID\r\n  ,emp_code Username\r\n  ,emp_email Email\r\nfrom Emplo" +
                "yee \r\nwhere emp_code like @UserName\r\norder by emp_code asc";
            Statements[MembershipProviderSqlStatement.CountUsersByEmail] = "select count(*) from Employee where emp_email like @Email";
        ...
        public override void Initialize(string name, NameValueCollection config)
        {
            ...
            if (String.IsNullOrEmpty(name))
            	name = "VSMApplicationMembershipProvider";
            if (String.IsNullOrEmpty(config["description"]))
            {
                config.Remove("description");
                config.Add("description", "VSM application membership provider");
            }
            ...
            if (String.IsNullOrEmpty(_validationKey) || _validationKey.Contains("AutoGenerate"))
            	_validationKey = "8561ACADEC26732614EDDDD2E1114DD4F14068803A60EF20A447DEF3B8245765ACC43283CE03301FD" +
                    "93039B53730EFFE054B3B22D1A9D9C73FB1299364AE7948";
        }
