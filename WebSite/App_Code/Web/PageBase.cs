...
namespace VSM.Web
{
    ...
    public class PageBaseCore : System.Web.UI.Page
    {
        ...
        protected override void Render(HtmlTextWriter writer)
        {
            ...
            tempWriter.Flush();
            tempWriter.Close();
            string page = VSM.Data.Localizer.Replace("Pages", Path.GetFileName(Request.PhysicalPath), sb.ToString());
    ...
    public class ControlBaseCore : System.Web.UI.UserControl
    {
        ...
        protected override void Render(HtmlTextWriter writer)
        {
            ...
            tempWriter.Flush();
            tempWriter.Close();
            writer.Write(VSM.Data.Localizer.Replace("Pages", Path.GetFileName(Request.PhysicalPath), sb.ToString()));
        }
